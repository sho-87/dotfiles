...
#+RESULTS:
: #s(hash-table size 65 test eql rehash-size 1.5 rehash-threshold 0.8125 data (:use-package (26054 11431 792132 0) :use-package-secs (0 0 231 0) :init (26054 11217 573839 0) :config (26054 11217 573835 0) :config-secs (0 0 47 0) :init-secs (0 0 5445 0)))
