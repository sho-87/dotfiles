...
This function should only modify configuration layer settings."
  (setq-default
   ...
   dotspacemacs-additional-packages '(autothemer move-text)
...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   dotspacemacs-themes '((kanagawa :location local)
                         spacemacs-dark
                         spacemacs-light)
...
before packages are loaded."
  (define-key evil-normal-state-map [escape] (lambda () (interactive) (evil-ex-nohighlight)))
  (global-set-key (kbd "C-s") 'save-buffer)
  (global-set-key (kbd "M-j") 'move-text-down)
  (global-set-key (kbd "M-k") 'move-text-up)
  (define-key evil-insert-state-map (kbd "C-v") 'yank)
  ;; (evil-leader/set-key "G" (lambda () (interactive) (kbd "mg") (evil-goto-line (line-number-at-pos (point-max)))))
  ...
  ;; Hide all Consult sources, except normal buffers
