	...
	require("kanagawa").setup({
		...
		overrides = function(colors) -- add/modify highlights
			return {
				...
				BufferLineNumbersSelected = { bg = colors.palette.fujiWhite, fg = colors.palette.sumiInk0 },
				BufferLineCloseButtonSelected = { bg = colors.palette.fujiWhite, fg = colors.palette.sumiInk0 },
				BufferLineSeparatorSelected = { bg = colors.palette.fujiWhite, fg = colors.palette.sumiInk0 },
				BufferLineBufferSelected = { bg = colors.palette.fujiWhite, fg = colors.palette.roninYellow },
				BufferLinePickSelected = { bg = colors.palette.fujiWhite, fg = colors.palette.sumiInk0 },
				BufferLineIndicatorSelected = { bg = colors.palette.fujiWhite, fg = colors.palette.sumiInk0 },
				BufferLineInfoSelected = { bg = colors.palette.fujiWhite, fg = colors.palette.sumiInk0 },

				BufferLineNumbersVisible = { bg = colors.palette.autumnGreen, fg = colors.palette.sumiInk0 },
				BufferLineCloseButtonVisible = { bg = colors.palette.autumnGreen, fg = colors.palette.sumiInk0 },
				BufferLineSeparatorVisible = { bg = colors.palette.autumnGreen, fg = colors.palette.sumiInk0 },
				BufferLineBufferVisible = { bg = colors.palette.autumnGreen, fg = colors.palette.sumiInk0 },
				BufferLinePickVisible = { bg = colors.palette.autumnGreen, fg = colors.palette.sumiInk0 },
